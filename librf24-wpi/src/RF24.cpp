/*
 ...
 based on Copyright (C) 2011 J. Coliz <maniacbug@ymail.com>
...
#define __msleep(msec)	usleep(msec*1000L);
...
{
  if (!inited) {
	  spi = new SPI(_spidev, SPI_COMMUNICATION_FREQUENCY, 8);
	  #ifndef GPIO_WPI
	  gpio = new GPIO();
